    ...
    <DefaultDiv className={"pt-60 pb-26"}>
        <div className="flex gap-12 justify-between items-center">
          <div className="w-135 h-60">
            <h1 className="text-5xl font-bold">Hola, Soy yo 👋</h1>
            <p className="pt-4 text-neutral-300 text-lg w-135">
          ...
          <div className="relative w-130 h-100">
            <img
              ...
              alt=""
            />
            <div className="w-130 h-100 bg-slate-800 absolute -top-9 -right-9 z-10" />
          </div>
      </div>
